...
** THIS IS WORK IN PROGRESS  - DO NOT USE JUST YET **
...
``` sh
storm local target/carbontxt-crawler-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux injection.flux --local-ttl 3600
```
...
``` sh
storm jar target/carbontxt-crawler-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux crawler.flux
```
